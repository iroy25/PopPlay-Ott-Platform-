...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Ultimate destination for endless entertainment</title>
...
* {
  ...
  body {
	height:100%;
	background: linear-gradient(rgba(35, 28, 28, 0.758), rgba(10, 10, 10, 0.903));
	width:100%;
...
@media screen and (max-width: 540px) {
  ...
  <body>
	<div class="header">
		<nav>
			<a href="index2"><img src="images/logo1.png" class="logo" alt=""></a>
			<div>
				<a href="index2"><button>Home</button></a>
				<a href="movielistafter"><button>Movies</button></a>
