...
.logo{
    ...
    width: 150px;
        ...
        .wrapper .input-box {
            ...
            position: relative;
            margin: 30px 0;
            border-radius: 25px; /* Make the container fully rounded */
        }
        .wrapper .input-box input {
            ...
            border: none;
            outline: none;
            border-radius: 25px; /* Apply the same border-radius to input */
            font-size: 16px;
            color: #9a5555;
            padding: 0 20px; /* Adjust padding to fit inside the rounded container */
        }
